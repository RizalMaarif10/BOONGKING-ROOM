...
@section('content')
    ...
    {{-- ── HERO ── --}}
    <div
        style="background:linear-gradient(135deg,#0f172a 0%,#1e3a5f 60%,#1d4ed8 100%);border-radius:20px;padding:44px 40px;margin-bottom:28px;position:relative;overflow:hidden;">
        <div
        ...
        <div style="position:relative;z-index:1;">
            ...
            <div class="d-flex align-items-center gap-3 flex-wrap">
                <a href="{{ route('booking.create') }}"
                    style="display:inline-flex;align-items:center;gap:8px;background:linear-gradient(135deg,#3b82f6,#1d4ed8);color:white;font-size:0.85rem;font-weight:700;padding:10px 20px;border-radius:10px;text-decoration:none;box-shadow:0 4px 14px rgba(59,130,246,0.4);">
                    <i class="bi bi-calendar2-plus"></i> Buat Booking Baru
                </a>
                <a href="{{ route('booking.index') }}"
                    style="display:inline-flex;align-items:center;gap:6px;background:rgba(255,255,255,0.1);border:1px solid rgba(255,255,255,0.2);color:white;font-size:0.82rem;font-weight:700;padding:10px 18px;border-radius:10px;text-decoration:none;">
    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-md-3">
            <div class="card h-100" style="border-left:4px solid #3b82f6 !important;">
                <div class="card-body d-flex align-items-center gap-3 py-3">
                    <div
                        style="width:42px;height:42px;border-radius:12px;background:linear-gradient(135deg,#3b82f6,#1d4ed8);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                        <i class="bi bi-building text-white" style="font-size:1rem;"></i>
                    </div>
                    <div>
                        <div style="font-size:0.68rem;font-weight:700;color:#94a3b8;text-transform:uppercase;">Total Ruangan
                        </div>
                        <div style="font-size:1.6rem;font-weight:800;color:#0f172a;line-height:1.1;">{{ $allRooms }}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-6 col-md-3">
            <div class="card h-100" style="border-left:4px solid #8b5cf6 !important;">
                <div class="card-body d-flex align-items-center gap-3 py-3">
                    <div
                        style="width:42px;height:42px;border-radius:12px;background:linear-gradient(135deg,#8b5cf6,#6d28d9);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                        <i class="bi bi-calendar2-check text-white" style="font-size:1rem;"></i>
                    </div>
                    <div>
                        <div style="font-size:0.68rem;font-weight:700;color:#94a3b8;text-transform:uppercase;">Booking Saya
                        </div>
                        <div style="font-size:1.6rem;font-weight:800;color:#0f172a;line-height:1.1;">{{ $myBookings }}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-6 col-md-3">
            <div class="card h-100" style="border-left:4px solid #f59e0b !important;">
                <div class="card-body d-flex align-items-center gap-3 py-3">
                    <div
                        style="width:42px;height:42px;border-radius:12px;background:linear-gradient(135deg,#f59e0b,#d97706);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                        <i class="bi bi-hourglass-split text-white" style="font-size:1rem;"></i>
                    </div>
                    <div>
                        <div style="font-size:0.68rem;font-weight:700;color:#94a3b8;text-transform:uppercase;">Menunggu
                        </div>
                        <div style="font-size:1.6rem;font-weight:800;color:#0f172a;line-height:1.1;">{{ $myPending }}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-6 col-md-3">
            <div class="card h-100" style="border-left:4px solid #22c55e !important;">
                <div class="card-body d-flex align-items-center gap-3 py-3">
                    <div
                        style="width:42px;height:42px;border-radius:12px;background:linear-gradient(135deg,#22c55e,#15803d);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                        <i class="bi bi-tags text-white" style="font-size:1rem;"></i>
                    </div>
                    <div>
                        <div style="font-size:0.68rem;font-weight:700;color:#94a3b8;text-transform:uppercase;">Jenis Ruangan
                        </div>
                        <div style="font-size:1.6rem;font-weight:800;color:#0f172a;line-height:1.1;">
                            {{ $jenisRuangan->count() }}</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 gap-3 flex-wrap">
        <div class="d-flex align-items-center gap-2 flex-wrap">
            ...
            @foreach ($jenisRuangan as $jenis)
                <a href="{{ route('rooms', ['jenis' => $jenis->id]) }}"
                    class="d-inline-flex align-items-center gap-1 px-3 py-2 rounded-3 text-decoration-none"
                    style="font-size:0.8rem;font-weight:700;
                    ...
                    {{ $jenis->nama }}
                    <span style="font-size:0.68rem;opacity:0.6;">({{ $jenis->rooms_count }})</span>
                </a>
            @endforeach
        </div>
        <span style="font-size:0.8rem;color:#94a3b8;font-weight:600;">
            {{ $rooms->count() }} ruangan ditemukan
        </span>
    </div>
    ...
    <div class="row g-4">
        @forelse($rooms as $room)
            @php
                $idx = max(0, $room->jenis_ruangan_id - 1) % count($bandColors);
                    ...
                    <div class="card-body p-4 d-flex flex-column">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex flex-wrap gap-1">
                                @php $fasArr = array_filter(array_map('trim', explode(',', $room->fasilitas ?? ''))); @endphp
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body text-center py-5">
                        ...
                        <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:8px;">Tidak ada ruangan untuk filter ini.
                        </p>
                        <a href="{{ route('rooms') }}"
